...
module.exports =
  ...
  'input[name*=email]'        : random.email(),
  'input[name*=number]'       : random.number(8),
  'input[class*=number]'      : random.number(8),
  'input[class*=decimal]'     : random.number(8),
  'input[name*=phone]'        : random.phoneNumber(5),
